<%-- 
    Document   : Export-ETSTDC
    Created on : Sep 17, 2020, 2:59:39 PM
...
<div class="content">
    ...
    <div class="animated fadeIn">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">              
                    <form method="post" action="/etestgbackend/ExportETSTDC?Export=FindExport">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12" style="margin-left: 15px;"><label class="fontvwhead">
                                    <i class="fa fa-puzzle-piece"></i> Export ET_STDC text file.</label>
                                    <br/>
                                </div>
                            </div>
                            <hr>
                            ...
                            <div class="row text-center" style="display: block;  align-items: center; justify-content: center; margin-top: 20px;"> 
                                <div class="col-12 text-center" style="text-align: center;">
                                    <h3 style="color: #000;">คลิกที่ปุ่มเพื่อ ดาวน์โหลดไฟล์ ET_STDC </h3><br>
                                    <button type="submit" class="btn btn-success" onclick="return confirm('คุณต้องการ ดาวน์โหลดไฟล์ ET_STDC ใช่หรือไม่?');"
                                            style="border-radius: 0; box-shadow: 0 0 5px 0 rgba(0, 0, 0, 0.5); color: #fff; padding: 15px 25px; font-size: 18px;">
                                        <i class="fa fa-save"></i> ดาวน์โหลดไฟล์ ET_STDC 
                                    </button> 
                                </div>
                            </div>                            
                        </div>
