    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (SECTION.equals("0")) { //--- ค้นข้อมูลทั้งหมด คาบสอบ
            ...
            if (ExamDate.equals("0")) { // --- ค้นข้อมูลทั้งหมด วัน/เดือน/ปี
                ...
                // ----- สถานะการจ่ายเงิน เพื่อไปแสดง --------------------------------
                ReceiptData = getReceiptTable.findAllDateAllSection(YEAR, SEMESTER);// --- ค้นข้อมูลทั้งหมด ทุก วัน/เดือน/ปี ที่สอบ และทุกคาบสอบ

            } else {

                ReceiptData = getReceiptTable.findAllSectionByDate(YEAR, SEMESTER, changeDate(ExamDate));// --- ค้นข้อมูล ทุก คาบสอบ ตาม วัน/เดือน/ปี ที่สอบ
            ...
            if (ExamDate.equals("0")) { // --- ค้นข้อมูลทั้งหมด วัน/เดือน/ปี
                ...
                ReceiptData = getReceiptTable.findAllDateBySection(YEAR, SEMESTER, SECTION);// --- ค้นข้อมูลทั้งหมด วัน/เดือน/ปี ตามคาบสอบที่ต้องการ
            } else {

                ReceiptData = getReceiptTable.findByDateBySection(YEAR, SEMESTER, changeDate(ExamDate), SECTION);// --- ค้นข้อมูล ตาม วัน/เดือน/ปี และคาบที่เลือก
            }
        }
        ...
        if (!ReceiptData.isEmpty()) {
            ...
            out.println("alert('วันสอบและคาบสอบ ที่ทำการเลือกนักศึกษาชำระเงินเรียบร้อยแล้ว หรือไม่มีนักศึกษาลงทะเบียนสอบ!!!');");
