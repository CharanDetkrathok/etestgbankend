...
public class RepETesting101 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getParameter("sumitt") != null) {
            ...
            RequestDispatcher rs = request.getRequestDispatcher("admin/Rep-ETesting101-Main.jsp");
            rs.forward(request, response);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(RepETesting101.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
