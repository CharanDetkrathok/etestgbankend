...
public class ShowStdRegisterAll extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (getCounterData != null) {
            ...
            RequestDispatcher rs = request.getRequestDispatcher("admin/ShowStdRegisAllReport.jsp");
        ...
        /* PrintWriter out = response.getWriter();
         try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ShowStdRegisterAll</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ShowStdRegisterAll at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        } finally {
            out.close();
