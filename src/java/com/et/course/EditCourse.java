...
public class EditCourse extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String coursenoTmp = request.getParameter("coursenoTmp");
        ...
        boolean chkEditCourse = false;

        if (getCounterData != null && courseno != null) {
            editCourse.setCOURSE_NO(courseno);
            editCourse.setCREDIT(new BigDecimal(credit));
            // editCourse.setCOURSE_NO(courseno);
            editCourse.setSEMESTER(sem);
            editCourse.setYEAR(year);
            chkEditCourse = getCourseTable.editCourse(editCourse, coursenoTmp);
            if (chkEditCourse) {
                // db.commit();
         ...
         * out.println("<title>Servlet EditCourse</title>"); out.println("</head>");
         * out.println("<body>"); out.println("<h1>Servlet EditCourse at " +
