                    ...
                    <form method="post" action="/etestgbackend/GetRegisterSelectReport" >
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12" style="margin-left: 15px;"><label class="fontvwhead">
                                        <i class="fa fa-puzzle-piece"></i> รายงานลงทะเบียนทั้งหมด</label><br /> <hr></div>
                            </div>
                        ...
                        <div class="row" style="margin-top: 20px;"> 
                            <div class="col-12" style="text-align: center;">
                                <button type="submit" class="btn btn-primary" ><i class="fa fa-save"></i> ออกรายงาน</button> 
                                <button type="button" class="btn btn-danger"><i class="fa fa-close"></i> ยกเลิก </button> 
                            </div>
