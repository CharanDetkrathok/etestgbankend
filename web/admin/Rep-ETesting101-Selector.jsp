<%-- 
    Document   : Rep-ETesting101-Selector
    Created on : Jan 22, 2021, 10:13:18 AM
...
<div class="content">
    ...
    <div class="animated fadeIn">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">              
                    <form method="post" action="/etestgbackend/RepETesting101?sumittt=1">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row" style="display: flex; align-items: center; justify-content: center;">
                                ...
                                <div class="col-6" style="text-align: center; margin: 32px 0 0 -50px; padding: 0 0 0 0;">
                                    ...
                                    <a type="button" href="/etestgbackend/RepETesting101" class="btn btn-warning"
